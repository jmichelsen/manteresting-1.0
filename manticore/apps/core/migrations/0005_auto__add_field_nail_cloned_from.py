...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Nail.cloned_from'
        db.add_column('core_nail', 'cloned_from', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='clones', null=True, to=orm['core.Nail']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Nail.cloned_from'
        db.delete_column('core_nail', 'cloned_from_id')
