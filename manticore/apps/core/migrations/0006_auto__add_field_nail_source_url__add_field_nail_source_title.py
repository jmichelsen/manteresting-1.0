...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Nail.source_url'
        db.add_column('core_nail', 'source_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Nail.source_title'
        db.add_column('core_nail', 'source_title', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Nail.source_url'
        db.delete_column('core_nail', 'source_url')

        # Deleting field 'Nail.source_title'
        db.delete_column('core_nail', 'source_title')
