...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Nail.user'
        db.add_column('core_nail', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='nails', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Nail.user'
        db.delete_column('core_nail', 'user_id')
