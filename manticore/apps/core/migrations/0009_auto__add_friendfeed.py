...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FriendFeed'
        db.create_table('core_friendfeed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='friendfeed', to=orm['auth.User'])),
            ('nail', self.gf('django.db.models.fields.related.ForeignKey')(related_name='friendfeed', to=orm['core.Nail'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('core', ['FriendFeed'])


    def backwards(self, orm):
        
        # Deleting model 'FriendFeed'
        db.delete_table('core_friendfeed')
