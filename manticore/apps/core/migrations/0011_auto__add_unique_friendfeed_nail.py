...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Nail', fields ['timestamp']
        db.create_index('core_nail', ['timestamp'])

        # Adding unique constraint on 'FriendFeed', fields ['nail']
        db.create_unique('core_friendfeed', ['nail_id'])

        # Adding index on 'FriendFeed', fields ['timestamp']
        db.create_index('core_friendfeed', ['timestamp'])


    def backwards(self, orm):
        
        # Removing index on 'FriendFeed', fields ['timestamp']
        db.delete_index('core_friendfeed', ['timestamp'])

        # Removing unique constraint on 'FriendFeed', fields ['nail']
        db.delete_unique('core_friendfeed', ['nail_id'])

        # Removing index on 'Nail', fields ['timestamp']
        db.delete_index('core_nail', ['timestamp'])
    ...
    models = {
        ...
        'core.friendfeed': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nail': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'friendfeed'", 'unique': 'True', 'to': "orm['core.Nail']"}),
