...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FriendFeed.ref_count'
        db.add_column('core_friendfeed', 'ref_count', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FriendFeed.ref_count'
        db.delete_column('core_friendfeed', 'ref_count')
